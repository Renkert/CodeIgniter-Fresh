    	...
    	<div class="uk-container">
			<div class="uk-grid-margin uk-grid uk-grid-stack" uk-grid>
				<div class="uk-flex-auto uk-width-1-1@m">
    				...
    				<h1 class="uk-h1 uk-width-xlarge">Showcase/Design/Logo/Client_1</h1>
					<div class="uk-text-lead uk-width-xlarge">
						This is a Regular Controller, but the link is not regular.
					</div>
    			</div>
			</div>
		</div>
...
<div class="uk-section uk-padding-remove">
	<div class="uk-container uk-padding">
		...
		<table class="info">
			...
			<tr>
				<td>Segment 4:</td>
				<td><code><?php echo !empty($this->uri->segment(4)) ? $this->uri->segment(4) : 'empty';?></code></td>
			</tr>
			<tr>
				<td>Segment 5:</td>
				<td><code><?php echo !empty($this->uri->segment(5)) ? $this->uri->segment(5) : 'empty';?></code></td>
			</tr>
		</table>
	</div>
	<div class="uk-container uk-padding">
